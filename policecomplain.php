...
<head>
    ...
    <div class="container">
    <h2>PRIMARY COMPLAINT FROM APPLICANT</h2>
  <p></p>
  <table class="table">
    <thead class="thead-dark">
      <tr>
        ...
        <th>CONTACT</th>
        <th>CONVERT TO FIR</th>
      </tr>
    </thead>
    <tbody>
    <?php
     $con=mysqli_connect("localhost","root","","judiciary","3308");
     $sql="select * from usercomplain";
     $count=1;
    ...
    <tr>
        ...
        <td><?php echo $row['capp']; ?> </td>
        <td><?php echo $row['cresp']; ?></td>
        <td><?php echo $row['cdesc']; ?></td>
        <td><?php echo $row['caddrs']; ?></td>
        <td><?php echo $row['cpstation']; ?></td>
        <td><a href="#"><button type="button" class="btn btn-cool" style="float:right; margin-top:0px;">CONTACT</button></a> </td>
        <td><a href="#"><button type="button" class="btn btn-danger" style="float:right; margin-top:0px;">FIR</button></a> </td>
      </tr>
    <?php } ?>
    </tbody>
  </table>
