...
<h5 style="text-align:center;">YOUR STATE : <?php echo $_POST['pstate'];?></h5>
<h5 style="text-align:center;">YOUR DISTRICT : <?php echo $_POST['pdistrict'];?></h5>
<h6 style="text-align:center;">SELECT YOUR SDPO OFFICE
  <select name="sdpo">
    <option value="NASHIK RURAL">NASHIK RURAL</option>
    <option value="NIPHDA">NIPHAD</option>
    <option value="PETH">PETH</option>
    <option value="MALEGAON RURAL">MALEGAON RURAL</option>
    <option value="MALEGAN">MALEGAON</option>
  ...
  <select name="pstation">
    <option value="MALEGAON TALUKA">MALEGON TALUKA</option>
  ...
  <div class="container" style="background-image: url(images/policelogo.png);">
    <h3 style="text-align: center;">POLICE LOGIN</h3>
   
    <hr>
<form method="POST" action="policelogin1.php">
